  ...
  useEffect(() => {
    ...
    const t1 = setTimeout(
      () =>
        setMessages((prev) =>
          prev.map((m, i) =>
            i === prev.length - 1 ? { ...m, tick: "delivered" } : m,
          ),
        ),
      1000,
    );
  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        background:
          "linear-gradient(135deg, #f3e8ff 0%, #ede9fe 50%, #dbeafe 100%)",
      ...
      >
        ...
        <div
          style={{
            ...
            flexShrink: 0,
            background:
              "linear-gradient(180deg, #9b87f5 0%, #a78bfa 50%, #93c5fd 100%)",
            display: "flex",
        ...
        >
          ...
          >
            <div
              style={{
                ...
                height: 42,
                borderRadius: 14,
                background: activeContact.color,
                color: activeContact.text,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontWeight: 700,
            ...
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: "#3b0764" }}>
                {activeContact.name}
              </div>
              <div
                style={{
                  fontSize: 12,
                  color: otherTyping ? "#7c3aed" : "#a78bfa",
                }}
              >
            ...
            {messages.map((msg, i) => (
              <div
                ...
                style={{
                  display: "flex",
                  justifyContent:
                    msg.sender === "child" ? "flex-end" : "flex-start",
                  marginBottom: 2,
                }}
              >
                <div
          ...
          {safetyFlag && (
            ...
            >
              ...
              >
                {safetyFlag === "unsafe_content" &&
                  "Is this unsafe? Talk to a trusted adult. Helpline: 1098"}
                {safetyFlag === "pii_share" &&
                  "You're about to share personal info — are you sure?"}
                {safetyFlag === "platform_switch" &&
                  "This person is asking you to move platforms — red flag!"}
              </span>
              <button
                onClick={clearFlag}
                style={{
          ...
          >
            ...
            <button
              onClick={() => setSafetyFlag("unsafe_content")}
              style={{
                padding: "3px 10px",
            ...
            <button
              onClick={() => setSafetyFlag("pii_share")}
              style={{
                padding: "3px 10px",
            ...
            <button
              onClick={() => setSafetyFlag("platform_switch")}
              style={{
                padding: "3px 10px",
